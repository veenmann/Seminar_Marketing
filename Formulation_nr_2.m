function [w, gamma, y, f, x, t] = Formulation_nr_2(A, e)
% FORMULATION_NR_2 Linear Programming SVM training models for 4 different cases.
% [x, f, w, gamma, y, t] = Formulation_nr_2(A, e)
% Inputs: 
%   A       Data matrix
