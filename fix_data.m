function [V, e, allow_data_plot] = fix_data(use_user_input_data, user_input_data, use_linear_data,...
                                            nr_positive_labels, nr_negative_labels, nr_noise_points, ...
                                            add_random_noise, nr_data_columns)
% FIX_DATA Reads user data or generates random data
% [V, e, allow_data_plot] = fix_data(use_user_input_data, user_input_data, use_linear_data)
% Inputs:
...
if use_user_input_data
    ...
    if use_linear_data
        ...
        [V,e] = linear_data(nr_positive_labels, nr_negative_labels, ...
                            nr_noise_points, nr_data_columns, ...
                            add_random_noise);
    else
        % Create linearly non-separable data set
        [V,e] = circular_data(nr_positive_labels, nr_negative_labels, ...
